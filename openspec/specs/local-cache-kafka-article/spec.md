...
Defines the content, framing, and structural requirements for the site's Kafka-as-local-cache
article (`_articles/local-cache-via-kafka.md`) — the SEO/AEO conventions from `_articles/CLAUDE.md`
applied to this specific post.
